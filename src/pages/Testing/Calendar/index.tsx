...
const _Calendar: React.FC = () => {
    ...
    const generateCalendarGrid = useCallback(() => {
        ...
        console.log(moment(`${currentMoment.month() + 1}/1/${currentMoment.year()}`).format('MM/DD/YYYY'));
...
export const Calendar = () => {
    ...
    return <CalendarContext.Provider value={{ events, setEvents }}><_Calendar /></CalendarContext.Provider>
}